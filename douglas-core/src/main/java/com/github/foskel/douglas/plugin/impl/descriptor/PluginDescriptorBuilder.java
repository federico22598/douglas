...
public final class PluginDescriptorBuilder {
    ...
    private String mainClassPackageId;
    ...
    public PluginDescriptorBuilder withPackageId(String packageId) {
        this.mainClassPackageId = packageId;
    ...
    public PluginDescriptor build() {
        ...
        return this.mainClassName == null && this.mainClassPackageId == null
                ? this.dependency()
                : this.simple();
    }
